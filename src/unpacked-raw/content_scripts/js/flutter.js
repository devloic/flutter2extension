...
if (!_flutter) {
  ...
  (function () {
    ...
    function getBaseURI(appname) {
      /* 
      //lolopatch
      const base = "/content_scripts";
      return base; 
    //ENDlolopatch

      */
      const basestr = document.querySelector("base2").getAttribute("href")+appname+"/";
      return (basestr) || ""; 
    }
    ...
    _flutter.loader = new FlutterEntrypointLoader();
                 ...
                 onEntrypointLoaded: async function (engineInitializer) {
                   let appRunner = await engineInitializer.initializeEngine({
                     hostElement: function(){
                      let appname = engineInitializer.appname;
                      baseUri=ensureTrailingSlash(getBaseURI(appname));
                      let target = document.querySelector("#flutter_app-"+appname);  
                      return target;
                     }(),
                   });
